				<script>
					init.push(function () {
						...
						$('#jq-datatables-example_wrapper .table-caption').text('مجموعات الاعضاء');
...
<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">مجموعات الاعضاء</span>
					</div>
                     ...
                     <? } ?>
						<div class="table-light">
							<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
								...
								<tbody>
									<?
                                    $sql = "SELECT * FROM `group_users` ORDER BY `id` DESC";
