...
<div class="panel">
					...
					<div class="panel-body">
                                        <a href="?do=add&diploma_id=<?= $_GET['diploma_id'] ?>" class="btn btn-primary btn-add">جديد</a>
                     ...
                     <? } ?>
						<div class="table-light">
							<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
								...
								<tbody>
									<?
                                    $sql = "SELECT * FROM `pages` WHERE diploma_id=".$_GET['diploma_id']." AND insert_id=".$_SESSION['insert_id']." ORDER BY `id` DESC";
									...
									<tr class="odd gradeX">
									  ...
									  <td>
                                      <?
										$sql_menu = "SELECT * FROM `diploma` where id=".$result['diploma_id']."";
