				<script>
					init.push(function () {
						...
						$('#jq-datatables-example_wrapper .table-caption').text('عناصر الأحياء السكنية');
...
<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">الأحياء السكنية</span>
					</div>
                     ...
                     <? } ?>
						<div class="table-light">
							<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
								...
								<tbody>
									<?
                                    $sql = "SELECT * FROM `residential_neighborhoods` ORDER BY `id` DESC";
