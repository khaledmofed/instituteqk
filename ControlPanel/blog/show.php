				<script>
					init.push(function () {
						...
						$('#jq-datatables-example_wrapper .table-caption').text('قائمة الأخبار');
...
<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">الأخبار والمقالات</span>
					</div>
                     ...
                     <? } ?>
						<div class="table-light">
							<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
								...
								<tbody>
									<?
                                    $sql = "SELECT * FROM `blog` WHERE insert_id=".$_SESSION['insert_id']." ORDER BY `id` DESC";
									...
									<tr class="odd gradeX">
									  ...
									  <td><?= $result['title'] ?></td>
									  <td><?
										$sql_menu = "SELECT * FROM `blog_category` where id=".$result['category_id']."";
