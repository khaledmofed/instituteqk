				<script>
					init.push(function () {
						...
						$('#jq-datatables-example_wrapper .table-caption').text('قائمة المقررات الدراسية');
...
<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">المقررات الدراسية</span>
					</div>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
								<thead>
									<tr>
									  ...
									  <th>المجال</th>
									  <th> المستوى</th>
									  <th>الوحدات التعليمية</th>
									  <th>الوزن النسبي للمقرر</th>
									  <th></th>
									</tr>
								</thead>
								<tbody>
									...
									<tr class="odd gradeX">
									  ...
									  <td><?= $result['title'] ?></td>
									  <td><?
										$sql_menu = "SELECT * FROM `diploma_area` where id=".$result['area_id']."";
