...
#############################################################
    ...
    if(isset($_POST['btnadd'])) {
		...
		$insert						= $pdo->pdoInsUpd('slideshow', $data);
...
#############################################################
    ...
    if(isset($_POST['btnedit'])) {
		...
		$data['img']				= $file;
		$where[id] 					= $_GET['id'];
		$update 					= $pdo->pdoInsUpd('slideshow', $data, 'update', $where);
		header('Location: ?do=show&process=successfully');
    }
...
<? include('right.php') ?>
    ...
    <?
        ...
        {
        case "show":
        include("template/slideshow/show.php");
        break;
        case "add":
        include("template/slideshow/add.php");
        break;
        case "edit":
        include("template/slideshow/edit.php");
        break;
        }
