...
#############################################################
    ...
    if(isset($_POST['btnadd'])) {
		...
		$insert						= $pdo->pdoInsUpd('group_users', $data);
...
#############################################################
    ...
    if($_GET['do'] == 'edit'){
        $sql = "SELECT * FROM `group_users` where id=:id";
        $data[id] = $_GET['id'];
...
#############################################################
    ...
    if(isset($_POST['btnedit'])) {
		$data['title']					= trim($_POST['title']);
		$where[id] 						= $_GET['id'];
		$update 						= $pdo->pdoInsUpd('group_users', $data, 'update', $where);
		header('Location: ?do=show&process=successfully');
    }
...
<? include('right.php') ?>
    ...
    <?
        ...
        {
        case "show":
        include("template/group_users/show.php");
        break;
        case "add":
        include("template/group_users/add.php");
        break;
        case "edit":
        include("template/group_users/edit.php");
        break;
        }
