                  ...
                  <div class="sp-column ">
                     ...
                     <div id="sp-page-builder" class="sp-page-builder  page-7">
                        <div class="page-content">
                                                      ...
                                                      <ul>
                                                        ...
                                                        ?>                                                         
                                                         ...
                                                         <li data-transition="random-premium" data-slotamount="7" data-masterspeed="300">
                                                            <!-- MAIN IMAGE -->
                                                           <a href="<?=  $result_slide['url'] ?>"> <img src="<?= $site_url ?>/upload/<?= $result_slide['img'] ?>" alt="slide2" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat"></a>
                                                            <!-- LAYERS -->
                                                            <!-- LAYER NR. 1 
                           ...
                           <div class="clear"></div>
                           <!--<section class="sppb-section " style="margin:0px ;padding:30px 0px;background-color:#f5f5f5;">
                              <div class="sppb-container">
                                 <div class="sppb-row">
                                    <div class="sppb-col-sm-6">
                                       <div class="sppb-addon-container sppb-wow fadeInDown" style="" data-sppb-wow-duration="300ms" data-sppb-wow-delay="300ms">
                                          ...
                                          <div class="sppb-addon sppb-addon-feature sppb-text-center ">
                                             <div class="sppb-addon-content">
                                                <div class="sppb-icon"><span style="display:inline-block;text-align:center;;"><i class="fa fa-gear" style="font-size:42px;width:42px;height:42px;line-height:42px;;"></i></span></div>
                                                <h3 class="sppb-feature-box-title" style=""><a href="<?//= $site_url ?>/register.php">تسجيل الطالبات</a></h3>
                                             </div>
                                          </div>
                                       </div>
                                    ...
                                    <div class="sppb-col-sm-6">
                                       <div class="sppb-addon-container sppb-wow fadeInDown" style="" data-sppb-wow-duration="300ms" data-sppb-wow-delay="400ms">
                                          ...
                                          <div class="sppb-addon sppb-addon-feature sppb-text-center ">
                                             <div class="sppb-addon-content">
                                                <div class="sppb-icon"><span style="display:inline-block;text-align:center;;"><i class="fa fa-envelope" style="font-size:42px;width:42px;height:42px;line-height:42px;;"></i></span></div>
                                                   ...
                                                   <div class="lan_vertical_timeline">
                                                      ...
                                                      <div class="lan_vertical_right tab-content">
                                                         ...
                                                         <div role="tabpanel" class="tab-pane <? if($i == 1) { echo 'active'; }?>" id="<?= $result_news['post_date'] ?>">
                                                            <div class="tab_img">
                                                               <img src="<?= $site_url ?>/upload/<?= $result_news['img'] ?>" alt="" />
                                                            </div>
                                                            <div class="tab_contain">
                                                               <h3><?= $result_news['title'] ?></h3>
                                                                            ...
                                                                            echo "<p>".$clean_text."</p>";
                                                                            ?>                                    
                                                               <a class="btn btn-primary" href="<?= $site_url ?>/post/<?= $result_news['seo_link'] ?>">التفاصيل</a>
                                                            </div>
                                                         </div>
                                                            <? $i++; } ?>
                                                      </div>
                                                                        ...
                                                                        <div class="ns2-column flt-left col-1">
                                                                           <div style="padding:3px 3px 3px 3px">
                                                                              <div class="ns2-inner">
                                                                                 ...
                                                                                 <h4 class="ns2-title">
                                                                                    <a href="<?= $site_url ?>/post/<?= $result_blog['seo_link'] ?>">
                                                                                    <?= $result_blog['title'] ?>
                                                                                    </a>
                                                                                 </h4>
                                                                                 <div class="ns2-tools">
                                                                                 ...
                                                                                 <a href="<?= $site_url ?>/post/<?= $result_blog['seo_link'] ?>">
                                                                                 <img class="ns2-image" style="float:left;margin:0 10px 0 0" src="<?= $site_url ?>/upload/<?= $result_blog['img'] ?>"  width="125px" height="90px" alt="Nullam velitmi feugiat etarcu neeh" title="Nullam velitmi feugiat etarcu neeh" />
                                                                                 </a>
                                                                                 <?
                           ...
                           <section id="lan_donate" class="sppb-section " style="padding:80px 0;color:#ffffff;background-image:url(<?= $site_url ?>/upload/<?= $calendar_img ?>);background-repeat:no-repeat;background-size:cover;background-attachment:fixed;background-position:50% 50%;">
                              <div class="sppb-container">
                                 <div class="sppb-row">
                                    <div class="sppb-col-sm-12">
														 ...
														 ?>
                                                                        ...
                                                                        <div class="ns2-column flt-left col-4">
                                                                           <div style="padding:0 15px">
                                                                              <div class="ns2-inner">
                                                                                 <a href="<?= $site_url ?>/post/<?= $result_event['seo_link'] ?>">
                                                                                 <img class="ns2-image" style="float:left;margin:0 0 20px 0" src="<?= $site_url ?>/upload/<?= $result_event['img'] ?>" alt="Nullam velitmi feugiat etarcu neeh" title="Nullam velitmi feugiat etarcu neeh" />
                                                                                 </a>
                                                                                 <h4 class="ns2-title">
                                                                                    <a href="<?= $site_url ?>/post/<?= $result_event['seo_link'] ?>">
                                                                                    <?= $result_event['title'] ?>
                                                                            ...
                                                                            ?>                                    
                                                                                 ...
                                                                                 <div class="ns2-links">
                                                                                    <a class="sppb-btn sppb-btn-primary ns2-readmore" href="<?= $site_url ?>/post/<?= $result_event['seo_link'] ?>"><span>التفاصيل</span></a>
                                                                                 </div>
                                                                                 <div class="clear"></div>
                                                                              </div>
                                                                           </div>
                           ...
                           <section class="sppb-section " style="padding:30px 0 0 0;">
                              <div class="sppb-container">
                                 <div class="sppb-row">
                                    <div class="sppb-col-sm-12">
                                       <div class="sppb-addon-container sppb-wow fadeInRight">
                                          <div class="sppb-addon sppb-addon-text-block sppb-text-rigth lan_title">
                                             <h3 class="sppb-addon-title">شركاؤنا</h3>
                                             <div class="sppb-addon-content"></div>
                                          </div>
                                       </div>
                                    </div>
                                       ...
                                       <div class="sppb-addon-container sppb-wow fadeInUp">
                                          <div class="sppb-addon sppb-addon-module ">
                                             <div class="sppb-addon-content">
                                                <div id="ns2-123" class="nssp2 ns2-123">
                                                   <div class="ns2-wrap">
                                                      <div id="ns2-art-wrap1234" class="ns2-art-wrap nssp2-slide nssp2-default ">
                                                         <div class="ns2-art-pages nss2-inner">
                                                            <div class="ns2-page item active">
                                                               <div class="ns2-page-inner">
                                                                  <div class="ns2-row ns2-first ns2-odd">
                                                                     <div class="ns2-row-inner">
														<?
														 $sql_event = $pdo->pdoGetAll("SELECT * FROM `partners` ORDER BY `id` DESC LIMIT 0,4");
														 foreach($sql_event as $result_event) {
														 ?>
														...
														<?
														 $sql_event = $pdo->pdoGetAll("SELECT * FROM `partners` ORDER BY `id` DESC LIMIT 4,8");
														 foreach($sql_event as $result_event) {
														 ?>
