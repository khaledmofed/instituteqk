                     ...
                     <? } ?>
						<div class="table-light">
							<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
								...
								<tbody>
									<?
                                    $sql = "SELECT * FROM `pages` WHERE program_id=".$_GET['program_id']." AND insert_id=".$_SESSION['insert_id']." ORDER BY `id` DESC";
									...
									<tr class="odd gradeX">
									  ...
									  <td>
                                      <?
										$sql_menu = "SELECT * FROM `programs` where id=".$result['program_id']." AND insert_id=".$_SESSION['insert_id']."";
