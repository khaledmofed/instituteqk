				<script>
					init.push(function () {
						...
						$('#jq-datatables-example_wrapper .table-caption').text('الاقسام');
...
<div class="panel">
					...
					<a href="?do=add&type=<?= $_GET['type'] ?>" class="btn btn-primary btn-add">جديد</a>
                     ...
                     <? } ?>
						<div class="table-light">
							<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
								...
								<tbody>
									<?
                                    $sql = "SELECT * FROM `event_category` WHERE `event_type` = '".$_GET['type']."' ORDER BY `id` DESC";
