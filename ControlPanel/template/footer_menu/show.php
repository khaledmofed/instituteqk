				<script>
					init.push(function () {
						...
						$('#jq-datatables-example_wrapper .table-caption').text('عناصر القوائم');
...
<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">القوائم</span>
					</div>
                     ...
                     <? } ?>
						<div class="table-light">
							<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
								...
								<tbody>
									<?
                                    $sql = "SELECT * FROM `footer_menu` WHERE insert_id=".$_SESSION['insert_id']." ORDER BY `id` DESC";
