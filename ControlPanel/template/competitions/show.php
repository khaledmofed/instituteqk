				<script>
					init.push(function () {
						...
						$('#jq-datatables-example_wrapper .table-caption').text('قائمة المسابقات');
...
<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">قائمة المسابقات</span>
					</div>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
								...
								<tbody>
									...
									<tr class="odd gradeX">
									  <td><?= $result['id'] ?></td>
									  <td><?= $result['title'] ?></td>
									  <td><a href="pages.php?do=competitions_page&competition_id=<?= $result['id'] ?>">ادارة الصفحات</a></td>
									  <td><a href="students.php?do=show&competition=active&competition_id=<?= $result['id'] ?>">المقبولين في المسابقة</a></td>
									  <td class="center">
