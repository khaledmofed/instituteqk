...
#############################################################
    ...
    if(isset($_POST['btnadd'])) {
		...
		$insert						= $pdo->pdoInsUpd('events_programs', $data);
		header('Location: ?do=show&program_id='.$_GET['program_id'].'&process=successfully');
	}
...
#############################################################
    ...
    if($_GET['do'] == 'edit'){
        $sql = "SELECT * FROM `events_programs` where id=:id";
        $data[id] = $_GET['id'];
...
#############################################################
    ...
    if(isset($_POST['btnedit'])) {
		$data['title']				= trim($_POST['title']);
		$where[id] 					= $_GET['id'];
		$update 					= $pdo->pdoInsUpd('events_programs', $data, 'update', $where);
		header('Location: ?do=show&program_id='.$_GET['program_id'].'&process=successfully');
    }
...
<? include('right.php') ?>
    ...
    <?
        ...
        {
        case "show":
        include("template/events_programs/show.php");
        break;
        case "add":
        include("template/events_programs/add.php");
        break;
        case "edit":
        include("template/events_programs/edit.php");
        break;
        }
