...
#############################################################
    ...
    if(isset($_POST['btnadd'])) {
		...
		$insert						= $pdo->pdoInsUpd('diploma_area', $data);
...
#############################################################
    ...
    if($_GET['do'] == 'edit'){
        $sql = "SELECT * FROM `diploma_area` where id=:id";
        $data[id] = $_GET['id'];
...
#############################################################
    ...
    if(isset($_POST['btnedit'])) {
		$data['title']					= trim($_POST['title']);
		$where[id] 						= $_GET['id'];
		$update 						= $pdo->pdoInsUpd('diploma_area', $data, 'update', $where);
		header('Location: ?do=show&process=successfully');
    }
...
#############################################################
	...
	if(isset($_GET['del'])){
        $sql 		= "DELETE FROM `diploma_area` WHERE `id`=:id";
        $data[id] 	= $_GET['del'];
...
<? include('right.php') ?>
    ...
    <?
        ...
        {
        case "show":
        include("template/diploma_area/show.php");
        break;
        case "add":
        include("template/diploma_area/add.php");
        break;
        case "edit":
        include("template/diploma_area/edit.php");
        break;
        }
