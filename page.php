...
*/
	...
	// library
	if($result_pg['title'] == "المكتبة الإدارية") { header('Location: '.$site_url.'/library.php?id=1'); }
	if($result_pg['title'] == "المكتبة التعليمية والتربوية") { header('Location: '.$site_url.'/library.php?id=2'); }
	if($result_pg['title'] == "المكتبة العامة") { header('Location: '.$site_url.'/library.php?id=3'); }
