...
#############################################################
    ...
    if(isset($_POST['btnadd'])) {
		...
		$insert						= $pdo->pdoInsUpd('blog_category', $data);
...
#############################################################
    ...
    if(isset($_POST['btnedit'])) {
		$data['title']				= trim($_POST['title']);
		$where[id] 						= $_GET['id'];
		$update 						= $pdo->pdoInsUpd('blog_category', $data, 'update', $where);
		header('Location: ?do=show&process=successfully');
    }
...
<? include('right.php') ?>
    ...
    <?
        ...
        {
        case "show":
        include("template/blog_category/show.php");
        break;
        case "add":
        include("template/blog_category/add.php");
        break;
        case "edit":
        include("template/blog_category/edit.php");
        break;
        }
