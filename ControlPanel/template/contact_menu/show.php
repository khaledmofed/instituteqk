				<script>
					init.push(function () {
						...
						$('#jq-datatables-example_wrapper .table-caption').text('عناصر نموذج الاتصال');
...
<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">اقسام نموذج الاتصال</span>
					</div>
                     ...
                     <? } ?>
						<div class="table-light">
							<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
								...
								<tbody>
									<?
                                    $sql = "SELECT * FROM `contact_menu` ORDER BY `id` DESC";
